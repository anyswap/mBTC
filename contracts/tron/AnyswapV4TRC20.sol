...
abstract contract IAnyswapV3ERC20 is IERC20, IERC2612 {
    ...
    function approveAndCall(address spender, uint256 value, bytes calldata data) virtual external returns (bool);
    ...
    function transferAndCall(address to, uint value, bytes calldata data) virtual external returns (bool);
}
...
contract AnyswapV4ERC20 is IAnyswapV3ERC20 {
    ...
    bytes32 public TRANSFER_TYPEHASH = keccak256("Transfer(address owner,address to,uint256 value,uint256 nonce,uint256 deadline)");
